import React, { useState, useRef } from 'react';
      ...
      export const ProfilePage: React.FC = () => {
        ...
        const [documents] = useState([
          { id: '1', name: 'Blood Test Report - Jan 2025', type: 'report', date: '2025-01-10' },
          { id: '2', name: 'Prescription - Dr. Smith', type: 'prescription', date: '2025-01-08' },
        ...
        const addToList = (category: keyof ProfileData['medicalHistory'], value: string) => {
          if (value.trim()) {
            setProfileData(prev => ({
              ...prev,
              medicalHistory: {
        ...
        const removeFromList = (category: keyof ProfileData['medicalHistory'], index: number) => {
          setProfileData(prev => ({
            ...prev,
            medicalHistory: {
              ...prev.medicalHistory,
              ...
              >
                ...
                <p className="text-gray-600 text-sm">
                  {completionPercentage === 100 
                    ...
                    : `Complete your profile to get personalized health insights. ${8 - Math.round(completionPercentage / 12.5)} fields remaining.`
                  }
                </p>
              </motion.div>
                  ...
                  >
                    ...
                    {activeTab === 'medical' && (
                      <div className="space-y-8">
                        {Object.entries(profileData.medicalHistory).map(([category, items]) => (
                          <div key={category}>
                            ...
                            <div className="space-y-2">
                              {items.map((item, index) => (
                                <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                                  ...
                                  {isEditing && (
                                    <button
                                      onClick={() => removeFromList(category as keyof ProfileData['medicalHistory'], index)}
                              ...
                              {isEditing && (
                                <div className="flex space-x-2">
                                  <input
                                    ...
                                    onKeyPress={(e) => {
                                      if (e.key === 'Enter') {
                                        addToList(category as keyof ProfileData['medicalHistory'], e.currentTarget.value);
                                  ...
                                  <button
                                    onClick={(e) => {
                                      ...
                                      addToList(category as keyof ProfileData['medicalHistory'], input.value);
                                      input.value = '';
                                    }}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                          <div>
                            ...
                            <input
                              ...
                              onChange={(e) => {
                                ...
                                const weight = parseFloat(profileData.bodyMeasurements.weight);
                          ...
                          <div>
                            ...
                            <input
                              ...
                              onChange={(e) => {
                                const height = parseFloat(profileData.bodyMeasurements.height);
                    ...
                    {activeTab === 'documents' && (
                      <div className="space-y-6">
                        <div className="flex items-center justify-between">
                          <p className="text-gray-600">Securely store your medical documents</p>
                          <button
                            onClick={handleFileUpload}
                            className="flex items-center space-x-2 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors"
                          >
                            ...
                            <div key={doc.id} className="border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
                              <div className="flex items-start justify-between mb-3">
                                ...
                                <span className={`px-2 py-1 text-xs rounded-full ${
                                  doc.type === 'report' ? 'bg-blue-100 text-blue-600' :
                      ...
                      <div className="space-y-8">
                        <div className="bg-emerald-50 rounded-lg p-4 border border-emerald-200">
                          <div className="flex items-center space-x-2 mb-2">
                            ...
                            <h4 className="font-semibold text-emerald-900">This Week's Log</h4>
                          </div>
                          <p className="text-emerald-700 text-sm">Last updated: 2 days ago</p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          <div>
                            ...
                            <input
                              ...
                              onChange={(e) => setWeeklyLog(prev => ({ ...prev, weight: e.target.value }))}
                          ...
                          <div>
                            ...
                            <input
                              ...
                              onChange={(e) => setWeeklyLog(prev => ({ ...prev, waistCircumference: e.target.value }))}
                              className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                            />
                          </div>
                          <div>
                          ...
                          <div>
                            ...
                            <input
                              ...
                              onChange={(e) => setWeeklyLog(prev => ({ ...prev, restingHeartRate: e.target.value }))}
                              className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                            />
                          </div>
                          <div>
                            ...
                            <input
                              ...
                              onChange={(e) => setWeeklyLog(prev => ({ ...prev, sleepHours: e.target.value }))}
                              className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                            />
                          </div>
                          <div>
                            ...
                            <input
                              ...
                              onChange={(e) => setWeeklyLog(prev => ({ ...prev, waterIntake: e.target.value }))}
                              className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                            />
                          </div>
                          <div>
                            ...
                            <select
                              ...
                              onChange={(e) => setWeeklyLog(prev => ({ ...prev, energyLevel: e.target.value as any }))}
                              className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                            >
                          ...
                          <div>
                            <label className="block text-sm font-medium text-gray-700 mb-2">Exercise Frequency (times/week)</label>
                            <input
                              type="number"
                              value={weeklyLog.exerciseFrequency}
                              onChange={(e) => setWeeklyLog(prev => ({ ...prev, exerciseFrequency: e.target.value }))}
                              className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                            />
                          </div>
                        </div>
                        ...
                        <div className="border-t pt-6">
                          <h3 className="text-lg font-semibold text-gray-900 mb-4">Condition-Specific Metrics</h3>
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div>
                              ...
                              <input
                                ...
                                onChange={(e) => setWeeklyLog(prev => ({ 
                                  ...prev, 
                                  conditionSpecific: { ...prev.conditionSpecific, bloodSugar: e.target.value }
                                }))}
                                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                              />
                            </div>
                            <div>
                              <label className="block text-sm font-medium text-gray-700 mb-2">Pain Score (1-10)</label>
                              <input
                                type="number"
                                min="1"
                                max="10"
                                ...
                                onChange={(e) => setWeeklyLog(prev => ({ 
                                  ...prev, 
                                  conditionSpecific: { ...prev.conditionSpecific, painScore: e.target.value }
                                }))}
                                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                              />
                            </div>
